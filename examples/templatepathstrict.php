...
<h1>WATemplate path example, in strict mode</h1>
...
The template is in strict mode, that means ALL the meta elements values must be enclose with { { and } }.<br />
That means you can use any keyword into your data array and have no worries about html similar words.<br />
<br />
